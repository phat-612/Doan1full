        ...
        <div class="wrap_shop">
          ...
          <div class="info_pro">
            <ul class="information">
              ...
              <li class="price_item">
                <p class="num_price js_price_pro"></p>
              </li>
              <li>
                <p>Màu sắc:</p>
              ...
              <div class="information">
                <div class="detail_info">
                  <div class="head_info js_desc_ctrl">Thông tin<i class="fa-solid fa-chevron-down down_btn"></i></div>
                  <div class="info_main js_desc_content">
                  </div>
                </div>
              </div>
