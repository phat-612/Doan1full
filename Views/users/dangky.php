<div class="authen-form">
    <div class="auth-form_content">
        ...
        <div class="auth-form_group">
            <input type="date" name="sn" id="sn" placeholder="Ngày sinh" class="auth-form_input" required>
        </div>
        <div class="auth-form_group">
            <input type="password" name="pass" id="pass" placeholder="Mật khẩu" class="auth-form_input" required>
        </div>
        <div class="auth-form_group">
